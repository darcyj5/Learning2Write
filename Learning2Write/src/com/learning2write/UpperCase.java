...
public class UpperCase extends Activity implements ViewInterface, Serializable, Cloneable{
	...
	Model m = new Model(U); // creates an instance of the class Model
	//Context context;
	//DrawUpper d = new DrawUpper(context);
	//d.canvas;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.uppercase);
        ...
        back.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
				Intent myIntent = new Intent(UpperCase.this, MainActivity.class); // Creates an Intent to go back to the MainActivity
